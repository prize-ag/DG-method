...
MODULE MODAL_DG_1D_GLOBALS
  ...
  REAL( 8 ), DIMENSION( 1 : NLEV + 1 )                               :: L2_ERR, LINF_ERR
...
PROGRAM MODAL_DG_1D
  ...
  DO I0 = 1, NLEV + 1
      ...
      DO I = 1, IMAX
          ...
          WRITE( UNIT_ID, '(3(1X, ES24.16E3))' ) X( I ), U_REF( I ), NEW_U( I )
...
CONTAINS
  ...
  SUBROUTINE COMPUTE_REFERENCE_AND_SAVE
    ...
    DO WHILE ( ( FLAG_FINE_0 < TIME_OUT ) .AND. ( N_FINE <= NMAX ) )
        ...
        CALL GET_RK      ( RK_ORD, POLY_ORD, Q, M, L_B, R_B, I_BC, IMAX_FINE, X_FINE, DX_FINE, MAXDX_FINE, DT_FINE, OLD_DEG_FINE, NEW_DEG_FINE )
